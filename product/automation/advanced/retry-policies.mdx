---
title: "Retry Policies: Backoff and Dead-Letter Handling"
sidebarTitle: "Retry policies"
description: "Configure exponential backoff with jitter, set maximum retry attempts, and route poison messages to dead-letter queues in Key Nine Studios automation workflows."
---

Retry policies in Key Nine Studios automation turn transient failures into eventual success—when configured carefully. Backoff spreads load; max attempts bound damage; dead-letter queues preserve poison messages for inspection instead of infinite loops.
