---
title: "Conditions and Branches in Workflow Builder"
sidebarTitle: "Conditions & branches"
description: "Model conditional logic in Key Nine Studios workflows using field comparisons and parallel branches, and define merge strategies when branches converge."
---

Branches in Key Nine Studios workflows let you mirror real decisions: approvals vs auto-reject, regional routing, or parallel reviews that must all pass. Invest time in condition clarity—ambiguous logic becomes expensive to debug under load.
