---
title: "Rules and Triggers for Key Nine Studios Automation"
sidebarTitle: "Rules & triggers"
description: "Choose trigger events, add field-level filters, and set concurrency guardrails to control when and how Key Nine Studios automation runs safely under load."
---

Rules in Key Nine Studios answer **when** something should run. Triggers are the signals—product events, webhooks, or schedules—that start evaluation. Filters and guardrails keep runs safe when traffic spikes or data is messy.
