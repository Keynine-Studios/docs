---
title: Key Nine Studios Help Center
description: Find answers about workspace setup, integrations, product how-tos, automation, and policies for Key Nine Studios—all in one place.
mode: custom
---
...
<div className="mx-auto flex w-full max-w-5xl flex-col gap-14 px-4 py-12 lg:py-16">
  <div className="flex flex-col items-center gap-12">
    <div className="flex w-full max-w-lg flex-col gap-1">
      ...
      <p className="text-center text-balance text-base text-gray-600 dark:text-gray-400 mt-2">
        Search the Key Nine Studios Help Center for setup guides, product how-tos, automation tips, and policies—all in one
        place.
      </p>
    </div>
  ...
  <div className="flex flex-col gap-2">
    ...
    <p className="text-base text-gray-600 dark:text-gray-400">
      Popular starting points from the Key Nine Studios Help Center
    </p>
  </div>
  ...
  <Columns cols={2} className="suggested-articles">
    ...
    <Card
      ...
      cta="Read article"
    >
      How Key Nine Studios collects, uses, and protects your data.
    </Card>
    <Card
